...
<p>I was too young to remember that first trip, but there were others sporadically over the years until I was 12 or 13. The last trip was not long before my grandfather died. By then I was taller than the wheat, but I could still stand inside the enormous wheel of the combine harvester for another picture before my dad hoisted me up on the seat beside the farmer. I rode along in wonder as great swaths of wheat were devoured in the wide mechanical jaws of the combine and whooshed over our heads into the truck behind.</p>

<h2>The Farm and The Prairie</h2>
...
<p>But the process, the way we got there, has a longer life-span. The process is the sediment, the deep root system where we store up knowledge over time. Each product we create is just what surfaces above ground, a crystallization of the sum total of everything we’ve learned up to that point. </p>
...
<p>The emergence of ideas like <a href="http://alistapart.com/article/responsive-web-design/">“responsive design”</a> and <a href="http://futurefriendlyweb.com/thinking.html">“future-friendly thinking”</a> are in part a response to the collective realization that designing products that solve one problem in one context at a time is no longer sustainable. By refocusing our process on systems that are explicitly designed to adapt to a changing environment, we have an opportunity to develop durable, long-lasting designs that renew their usefulness and value over time.</p>

<h2>Durable Systems</h2>

<p>Pentagram recently designed a <a href="http://new.pentagram.com/2013/06/new-work-nyc-wayfinding/">new system of pedestrian wayfinding signs for New York City</a>. The designers chose to create a complimentary system to the subway signage system designed by Massimo Vignelli almost a half-century earlier.</p>
...
<p>Vignelli designed another system, in 1977, for the National Park Service (NPS). The modular system, called the <a href="http://www.aisleone.net/2010/design/massimo-vignellis-unigrid-system/">“Unigrid,”</a> allowed the NPS to create multiple sizes of brochures, fold-out maps, and posters by reusing the same elements and structure across all the materials.</p>
...
<p>Even the most ambitious systems don’t always have what it takes to survive. <a href="http://www.nycsubway.org/perl/caption.pl?/img/maps/system_1972.jpg">Vignelli’s New York City subway map</a>, which he designed alongside the subway signage system, was famously replaced a few years later after continued complaints from subway riders. <a href="http://www.nytimes.com/2006/09/03/nyregion/thecity/03maps.html">Vignelli was quoted by <em>The New York Times</em></a>, calling the replacement map a “mongrel” for its messy mixing of “naturalism and abstraction” (Vignelli’s map was much-hated by New Yorkers for wildly misrepresenting above-ground distances in favor of diagrammatic purity). Michael Hertz, the designer of the map which long outlasted Vignelli’s own, <a href="http://gothamist.com/2007/08/03/michael_hertz_d.php">responded</a> that “mongrels” or “hybrids” are “usually healthier, smarter, and longer lived creatures than his ‘thoroughbred’ turned out to be.”</p>
...
<p><a href="http://en.wikipedia.org/wiki/Victor_Gruen">Victor Gruen</a>, an architect and city planner who grew up in Vienna, was disgusted by the American suburbs. Inspired by the broad plazas and civic centers of Europe, he hoped to design a new built environment that would restore a sense of civic life and community to the sprawling, isolating chaos of the suburbs. As the architect for the <a href="http://en.wikipedia.org/wiki/Southdale_Center">Southdale Mall</a> near Minneapolis, the first enclosed shopping center in the United States, his original designs included plans for a 400-acre development with apartment buildings, houses, schools, a medical center, parks, and a lake.</p>
...
<p>We can’t afford to follow the same model. We’re beginning to recognize our own monocultures as the short-lived efficiencies we extracted from them begin to unravel. The premise that we can design for a manageable number of combinations of screen sizes, platforms, contexts, and devices is quickly eroding. The diversity of variables in our ever-changing digital environment demand thoughtful systems designed around principles durable enough to outlast increasingly brief cycles of obsolescence.</p>
...
<h2>A Little Bit of Money and a Hundred Years</h2>
...
<p>They come for many of the same things you’d expect from a harvest festival in the American Midwest—food, music, dances, bonfires. But they also gather in this barn every year to discuss “the problem of agriculture,” in the words of <a href="http://en.wikipedia.org/wiki/Wes_Jackson">Wes Jackson</a>, who founded <a href="http://en.wikipedia.org/wiki/The_Land_Institute">The Land Institute</a> here with his wife Dana in 1971.</p>
